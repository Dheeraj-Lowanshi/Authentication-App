...
import com.auth_app.dtos.LoginRequest;
import com.auth_app.dtos.RefreshTokenRequest;
import com.auth_app.dtos.TokenResponse;
...
import com.auth_app.security.CookieService;
import com.auth_app.security.JwtService;
    ...
    private Optional<String> readRefreshTokenFromRequest(RefreshTokenRequest body, HttpServletRequest request) {
        ...
        if (request.getCookies() != null) {
            Optional<String> fromCookie = Arrays.stream(request.getCookies())
                    .filter(c -> cookieService.getRefereshTokenCookieName().equals(c.getName()))
                    .map(Cookie::getValue)
                    .filter(v -> !v.isBlank())
                    .findFirst();
